...
/**
 * Valida CPF
 * Algoritmo corrigido: count - 2 em vez de count - 12
 */
function isValidCPF(cpf) {
    ...
    const rest = (count) => {
        // Corrigido: count - 2 em vez de count - 12
        // Para count = 10: slice(0, 8) pega os 9 primeiros dígitos (índices 0-8)
        // Para count = 11: slice(0, 9) pega os 10 primeiros dígitos (índices 0-9)
        return cpfDigits.slice(0, count - 2)
...
if (typeof window !== 'undefined') {
    ...
    // Exportar também globalmente para compatibilidade
