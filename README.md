                ...
                try {
                    ...
                    for (const row of json) {
                        const courseData = {
                            ...
                            cargaHoraria: row['CARGA HORÁRIA'] || row['carga horária'] || '',
                            ...
                            nota: row['OBSERVAÇÃO'] || row['observação'] || ''
                        };
                    ...
                    // para garantir que a variável global 'cursos' seja atualizada corretamente
                    if (firebaseAvailable) {
                        loadData();
                    } else {
                        loadFromLocalStorage();
